                        ...
                        <div class='row'>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="idtype" class="form-control"
                                        value="@if(!empty($obprofile)){{$obprofile->idtype}} @endif" name="idtype"
                                        required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="idno" name="idno" value="{{ $obformassist->idno }}"
                                        class="form-control" required>
                        ...
                        <div class='row'>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{--  <input type="text" id="gender" value="{{ $obprofile->gender }}"
                                    class="form-control"> --}}
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="occupation" name="occupation"
                                        value="{{ $obprofile->occupation }}" class="form-control">
                                    @else
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="add1" name="add1" value="{{ $obprofile->add1 }}"
                                        class="form-control" required>
                                    @else
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="add2" name="add2" value="{{ $obprofile->add2 }}"
                                        class="form-control" required>
                                    @else
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="add3" name="add3" value="{{ $obprofile->add3 }}"
                                        class="form-control">
                                    @else
                        ...
                        <div class='row'>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="postcode" name="postcode" value="{{ $obprofile->postcode }}"
                                        class="form-control" required>
                                    @else
                                    <input type="text" id="+ " name="postcode" value="" class="form-control"
                                        required>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pobox" name="pobox" value="{{ $obprofile->pobox }}"
                                        class="form-control">
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lockedbag" name="lockedbag"
                                        value="{{ $obprofile->lockedbag }}" class="form-control">
                                    @else
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="wdt" name="wdt" value="{{ $obprofile->wdt }}"
                                        class="form-control">
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="city" name="city" value="{{ $obprofile->city }}"
                                        class="form-control" required>
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="telno" name="telno"
                                        value="@if(!empty($obprofile)){{ $obprofile->telno }} @endif"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" name="email"
                                        value="@if(!empty($obprofile)){{ $obprofile->email }} @endif"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
