    ...
    <div class="modal-dialog modal-simple" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="request_info">@lang('index.request_info')</h4>
            ...
            <div class="modal-body">
                <form novalidate>
                    ...
                    <div class="form-group">
                        <h5>@lang('modal.request_info.medical_report')</h5>
                        {{-- <div class="controls"> --}}
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                    ...
                    <div class="form-group">
                        <h5>@lang('modal.request_info.special_investigation')</h5>
                        {{-- <div class="controls"> --}}
                            <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                    ...
                    <div class="form-group">
                        <label for="others" class="control-label">@lang('modal.request_info.others')</label>
                        {{-- <div class="controls"> --}}
                            <textarea class="form-control" id="others" {{-- required data-validation-required-message="This field is required" --}} ></textarea>
                        {{-- </div> --}}
                    </div>
                    <div class="form-group">
                        <h5>@lang('modal.request_info.benefit_query')</h5>
                        {{-- <div class="controls"> --}}
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" {{-- required --}} value="benefit_query" class="custom-control-input" id="benefit_query">
                                <label class="custom-control-label" for="benefit_query">@lang('modal.request_info.penukaran_notis')</label>
                            </div>
                        {{-- </div> --}}
                    </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn waves-effect waves-light btn-danger" data-dismiss="modal">@lang('modal.cancel')</button></div>
