    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="#">
                    <div class="form-body">
                        <h4 class="card-title">@lang('History Benefit Information')</h4>
                        <hr>
                        <div id="accordion1" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="card-header" role="tab" id="headingOne1">
                                            <h5 class="mb-0">
                                                <a class="link" data-toggle="collapse" data-parent="#accordion1"
                                                    href="#collapseOne0" aria-expanded="true" aria-controls="collapseOne0"><i
                                                        class="fa fa-plus"></i>
                                                    Employment History
                                                </a>
                                            </h5>
                                        </div>
                                        <div id="collapseOne0" class="collapse show" role="tabpanel" aria-labelledby="headingOne0">
                                            <div class="card-body">
                                                <div class="form-body">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <div class="col-md-6 offset-6">
                                                                    <a class="btn btn waves-effect waves-light btn-success a1" data-toggle="collapse"
                                                                        data-target="#collapseOne0,#collapseOne11" aria-expanded="true"
                            ...
                            <div class="card">
                                <div class="card-header" role="tab" id="headingOne1">
                                    <h5 class="mb-0">
                                        <a class="link" data-toggle="collapse" data-parent="#accordion1"
                                            href="#collapseOne11" aria-expanded="true" aria-controls="collapseOne11"><i
                                                class="fa fa-plus"></i>
                                            Benefit History
                                        </a>
                                    </h5>
                                        ...
                                        <div class="form-body">
                                            <div class="row p-t-20">
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="col-md-6 offset-6">
                                                            <a class="btn btn waves-effect waves-light btn-success a1" data-toggle="collapse"
                                                                data-target="#collapseOne11,#collapseTwo22" aria-expanded="true"
                                ...
                                <div class="card-header" role="tab" id="headingTwo2">
                                    <h5 class="mb-0">
                                        <a class="collapsed link" data-toggle="collapse" data-parent="#accordion1"
                                            href="#collapseTwo22" aria-expanded="false" aria-controls="collapseTwo22"><i
                                                class="fa fa-plus"></i>
                                            ...
                                            <div class="row p-t-20">
                                                <div class="col-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <div class="col-md-6 offset-6">
                                                            <a class="btn btn waves-effect waves-light btn-success a1" data-toggle="collapse"
                                                                data-target="#collapseTwo22,#collapseThree333" aria-expanded="true"
                            ...
                            <div class="card ">
                                <div class="card-header" role="tab" id="headingThree333">
                                    <h5 class="mb-0">
                                        <a class="collapsed link" data-toggle="collapse" data-parent="#accordion1"
                                            href="#collapseThree333" aria-expanded="false" aria-controls="collapseThree333"><i
                                                class="fa fa-plus"></i>
