                                        ...
                                        <table id="demo-foo-row-toggler" class="table table-bordered" data-toggle-column="first">
                                            ...
                                            <tbody>
                                                <tr data-expanded="true">
                                                    ...
                                                    <td>
                                                        <div class="col-md-10">
                                                            <select class="form-control custom-select" data-placeholder="Month" tabindex="2">
                                                                {{-- <option>@lang('wages.select_month')</option> --}}
