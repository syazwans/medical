            ...
            <div class="card-body">
                ...
                <form class="mt-4">
                    <div class="row p-t-20">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">1. Section J Received</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">2. Complete Section J Received Date
                                </label>
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">3. Notice Date </label>
                                <input type="text" name="notice_date" id="notice_date" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">4. Acceptance stamp date
                                </label>
                                <input type="text" name="acceptance_stamp_date" id="acceptance_stamp_date"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="relationship_insured_person" id="relationship_insured_person"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="recipient_have_bank_account1">Yes</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="recipient_have_bank_account2"
                                        name="recipient_have_bank_account" class="custom-control-input">
                                    <label class="custom-control-label" for="recipient_have_bank_account2">No</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="overseas_bank_type_of_account"
                                        id="overseas_bank_type_of_account1" value="Saving" class="custom-control-input">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 m-b-20">
                                                <input type="text" class="form-control"
                                                    placeholder="Account Bank Number"> </div>
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="approver_supporting_document" id="approver_supporting_document"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
