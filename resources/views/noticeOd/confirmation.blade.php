 <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                <form action="/confirmation_od" method="POST">    
                    ...
                    <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" name="action" value="Save" class="btn waves-effect waves-light btn-success">@lang('confirmation.save')</button>
