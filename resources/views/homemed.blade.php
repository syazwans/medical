                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h3 class="m-b-0">3</h3>
                            <h5 class="text-muted m-b-0">New</h5></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h3 class="m-b-0">4</h3>
                            <h5 class="text-muted m-b-0">In Progress</h5></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h3 class="m-b-0">5</h3>
                            <h5 class="text-muted m-b-0">Completed</h5></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body m-10">
            ...
            <div class="table-responsive m-t-40">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-4">
                        ...
                        <div class="input-group-append">
                            <span class="input-group-text" style="background-color: skyblue;"><i class="ti-search"></i></span>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">OB NAME</label>
                    <div class="input-group col-4">
                ...
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">CASE ID</label>
                    <div class="input-group col-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>2019/05/01</td>
                            <td>1</td>
                            <td><a href="/information" id="status"><span class="label label-warning">In Progress</span></a></td>
                        </tr>
                        <tr>
                            <td>2019/05/01</td>
                            <td>36</td>
                            ...
                            <td>2019/05/01</td>
                            <td>57</td>
                            <td><a href="/information" id="status"><span class="label label-success">Completed</span></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
