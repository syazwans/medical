                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                        ...
                                        <textarea type="text" id="clinicname" name="clinicinfo" class="form-control">@if (!empty($mcdata)){{$mcdata[0]->clinicinfo}}@endif</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="hussts">
                                        ...
                                        @foreach($hussts as $typehus)
                                        @if (!empty($mcdata) && $mcdata->hussts == $typehus->refcode)
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">@lang('medicalDetails.attr.total_days')</label>
                                                            <input type="text" id="days" name="totalmc" value="@if (!empty($mcdata)) {{$mcdata[0]->mcinfo[0]->totalwork}} @endif" class="form-control" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <table id="demo-foo-row-toggler" class="table table-bordered attendtable" data-toggle-column="first">
                                                                ...
                                                                <tbody>
                                                                    <tr data-expanded="true" id="div_attend_work">
                                                                        <td>
                                                                            <div class="col-md-10">
                                                                                <input id="startdate1" name="workstartdate" type="text" 
                                                                                        value="@if (!empty($mcdata) && strlen($mcdata[0]->mcinfo[0]->workstartdate>0)) {{substr($mcdata[0]->mcinfo[0]->workstartdate,6,2)}}/{{substr($mcdata[0]->mcinfo[0]->workstartdate,4,2)}}/{{substr($mcdata[0]->mcinfo[0]->workstartdate,0,4)}} @endif" 
                                                                                        class="datepicker" placeholder="dd/mm/yyyy">
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="col-md-10">
                                                                                <input id="enddate1" name="workenddate" type="text" 
                                                                                    value="@if (!empty($mcdata) && strlen($mcdata[0]->mcinfo[0]->workenddate>0)) {{substr($mcdata[0]->mcinfo[0]->workenddate,6,2)}}/{{substr($mcdata[0]->mcinfo[0]->workenddate,4,2)}}/{{substr($mcdata[0]->mcinfo[0]->workenddate,0,4)}} @endif" 
                                                                                    class="datepicker" placeholder="dd/mm/yyyy">
                                                                            </div>
                                                                        </td>
                                                                        <td>  <input type="text" id="days1" name="totalwork" value="@if (!empty($mcdata)) {{$mcdata[0]->mcinfo[0]->totalwork}} @endif" class="form-control" placeholder=""></td>
                                                                        <td><!--input type="text" id="status" name="worksts" class="form-control" placeholder=""-->
                                                                            <select type="text" id="status" name="statuswork" class="form-control">
