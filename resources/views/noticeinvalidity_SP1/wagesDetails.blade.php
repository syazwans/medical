<div class="row">
 ...
 --}}                                                           <option value="January">@lang('wages.attr.january')</option>
                                        ...
                                        <div class="form-actions">
                                            <button type="button" class="btn btn waves-effect waves-light btn-secondary">@lang('wages.cancel')</button>
                                            <button type="button" class="btn btn waves-effect waves-light btn-secondary">@lang('wages.clear')</button>
                                            <button type="submit" class="btn btn waves-effect waves-light btn-success"> <i class="fa fa-check"></i>
                                            @lang('wages.save')</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
