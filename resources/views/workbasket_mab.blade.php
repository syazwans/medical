...
<div class="row">
    <div class="col-12">
        <div class="card card-body">
            <!-- Row -->
            <h4 class="card-title">WORKBASKET MEDICAL APPEAL BOARD</h4>
            <hr>
            <!-- Row -->
            <div class="row">
                <!-- Column -->
                                ...
                                <td>
                                    <div class="button-group">
                                        <button type="button" class="btn waves-effect waves-light btn-info">
                                            <div class="col-sm-6 col-md-4 col-lg-3"><i class="ti-check-box"></i></div>
                                        </button>
                                ...
                                <td>
                                    <div class="button-group ">
                                        <button type="button" class="btn waves-effect waves-light btn-danger">
                                            <div class="col-sm-6 col-md-4 col-lg-3"> <i class="ti-trash"></i> </div>
                                            </i> </div>
